...
<body>
			...
			<div class="container-contact100">
				<div class="wrap-contact100">
					<div class="contact100-form-title"
						...
						<span class="contact100-form-title-1"> Dentist Registration
							Form </span>
					</div>

					<form class="contact100-form validate-form" action="registerDentist"
	...
	if (status == "success") {
		swal("Success", 
			"Dentist successfully added.", 
			"success"
			).then((placeholder) => {
				window.location.href = "dentistList.jsp";
			});
	}
</script>
</body>
