		...
		<div class="container">
			<div id="pagination-container">
				...
				try {
					...
					String sql = "select iduserAccounts from users where useremail in (select email from customer where idcustomer = "+ id +");";
					...
					{
						data = "select custid, appointmentid, docname, services, date, apptime from appointment where custid = "
								+ id;
					}
				...
				<table border="1" class="table" id="patient-table">
						...
						<tr class="patient-row">
							...
							<td><a class="btn" href="./dentistViewAppointmentInfo.jsp?id=<%=rs.getInt(1)%>&appid=<%=rs.getInt(2)%>">View</a></td>
						</tr>
